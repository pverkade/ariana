describe("The rotate directive controller", function() {
    ...
    beforeEach(inject(
        function(_$controller_, _$rootScope_) {
            ...
            $controller = _$controller_("RotateCtrl", {$scope: $scope});
        })
    );
    ...
    describe("default variable", function() {
        it("toolname should match", function() {
            expect($scope.toolname).toEqual('rotate');
        });
    ...
    describe("init", function() {
        it("changes active state", function() {
            ...
            it("should change cursor", function() {
                $scope.init();
                expect($scope.getCursor()).toEqual('grab');
            });
